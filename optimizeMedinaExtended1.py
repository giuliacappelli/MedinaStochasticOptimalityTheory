...
# preliminary stats and plots to see individual and overall contribution of predictors to the actual judgments
	...
	tikzplotlib.save(outdir+'latex_preliminary_boxplot_iterativity.tex')
	plt.close()
...
# ----------------------------------------------------------------------------------
	...
	with open(outfolder+'errors.txt', 'w') as file_errors:
		...
		k = 4 # number of variables in the model (independent regressors): sps, tel, perf, iter
	...
	x_asptypes = [df_Tel["sps"].to_numpy(), df_Atel["sps"].to_numpy(), df_Perf["sps"].to_numpy(), df_Imperf["sps"].to_numpy(), df_Iter["sps"].to_numpy(), df_Noiter["sps"].to_numpy(), df_TelPerfIter["sps"].to_numpy(), df_TelImperfIter["sps"].to_numpy(), df_AtelPerfIter["sps"].to_numpy(), df_AtelImperfIter["sps"].to_numpy(), df_TelPerfNoiter["sps"].to_numpy(), df_TelImperfNoiter["sps"].to_numpy(), df_AtelPerfNoiter["sps"].to_numpy(), df_AtelImperfNoiter["sps"].to_numpy()]

	y_asptypes = [df_Tel["judg"].to_numpy(), df_Atel["judg"].to_numpy(), df_Perf["judg"].to_numpy(), df_Imperf["judg"].to_numpy(), df_Iter["judg"].to_numpy(), df_Noiter["judg"].to_numpy(), df_TelPerfIter["judg"].to_numpy(), df_TelImperfIter["judg"].to_numpy(), df_AtelPerfIter["judg"].to_numpy(), df_AtelImperfIter["judg"].to_numpy(), df_TelPerfNoiter["judg"].to_numpy(), df_TelImperfNoiter["judg"].to_numpy(), df_AtelPerfNoiter["judg"].to_numpy(), df_AtelImperfNoiter["judg"].to_numpy()]
